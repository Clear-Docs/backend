...
public class TochkaClient {
     ...
     */
    public TochkaClientAcquiringPaymentResponse createAcquiringPayment(TochkaClientAcquiringPaymentRequest requestDto) {
    ...
    public TochkaClientAcquiringPaymentResponse createAcquiringPayment(
        ...
        return createAcquiringPayment(TochkaClientAcquiringPaymentRequest.builder()
